...
public class MainActivity extends AppCompatActivity {
    ...
    private String postUrl = "https://accounts.google.com/ServiceLogin/identifier?service=mail&passive=true&rm=false&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F%3Ftab%3Dwm&scc=1&ltmpl=default&ltmplcache=2&emr=1&osid=1&flowName=GlifWebSignIn&flowEntry=AddSession&TL=AHnYQLzNrQZARmhTd6crpvkKpVOaF4tm2OPcEfwsGxILGA9SZub1lMa4XXaCN-E8czUPCjr-Otj9cJf8mMVNhXRGmt4pp6hj6J3tYv39OOzRILEQtimnOwxjfrFq9LggZTWSyhVBRF28oclnEI-JoaQixSIA6394CQ";
    ...
    private void initCollapsingToolbar() {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    ...
                    collapsingToolbar.setTitle("Gmail");
                    isShow = false;
                }
            }
        });
        ...
        Glide.with(getApplicationContext()).load("https://media.licdn.com/mpr/mpr/AAEAAQAAAAAAAArrAAAAJDU3NmM0ZDhmLTZjN2EtNDg4Ni1iYmE0LTRkOTRjYjM4YzRkNQ.png")
                .thumbnail(0.5f)
                .crossFade()
