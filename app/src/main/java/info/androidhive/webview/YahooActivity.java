...
public class YahooActivity extends AppCompatActivity {
    ...
    private String postUrl = "https://login.yahoo.com/config/login?.src=fpctx&.intl=in&.lang=en-IN&.done=https%3A%2F%2Fin.yahoo.com";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Utils.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(YahooActivity.this, YahooActivity.class);
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(YahooActivity.this, BrowserActivity.class);
    ...
    private void initCollapsingToolbar() {
        ...
        collapsingToolbar.setTitle("Amit Pramanik");
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle("Mailing Service");
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle("Yahoo");
                    isShow = false;
                }
            }
        });
        ...
        Glide.with(getApplicationContext()).load("http://1.bp.blogspot.com/-htyUoyaBNhQ/Ujwfujmqr0I/AAAAAAAACeA/Nui7DA3knnY/s1600/yahoo-logo.jpg")
                .thumbnail(0.5f)
                .crossFade()
